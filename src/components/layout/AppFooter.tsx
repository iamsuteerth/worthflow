...
interface AppFooterProps {
  /** Caps the inner content so footer items align with the page content columns.
      The border itself always spans the full width of the parent. */
  maxWidth?: number;
}

export default function AppFooter({ maxWidth = 1920 }: AppFooterProps) {
  return (
    <Box mt="xl" style={{ borderTop: "1px solid var(--mantine-color-default-border)" }}>
      <Group
        id="app-footer"
